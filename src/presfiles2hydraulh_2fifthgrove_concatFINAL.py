...
for file in in_files:
    ...
    if file == '207492_20231121_1609':
          # for dat['Time'] > the matlab datenum equivalent of 2023-07-20 00:00:00
          timingcorr = np.where(dat['Time'] > 19558+719529)
          dat['Time'][timingcorr[0][0]:] = dat['Time'][timingcorr[0][0]:]+27+(17.9)/24 # Timing issue found for this dataset
